...
public class ReturnDamageProcedure {
	public static String execute(Entity entity) {
		if (entity == null)
			return "";
		{
			double _setval = (entity.getCapability(CultivateModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new CultivateModVariables.PlayerVariables())).foundation_ratio / 25000;
