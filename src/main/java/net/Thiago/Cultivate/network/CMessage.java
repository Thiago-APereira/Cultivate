...
import net.Thiago.Cultivate.procedures.COnKeyPressedtrueProcedure;
...
public class CMessage {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			COnKeyPressedtrueProcedure.execute(entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		Cultivate.addNetworkMessage(CMessage.class, CMessage::buffer, CMessage::new, CMessage::handler);
	}
}
